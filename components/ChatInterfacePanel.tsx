      ...
      {isSaveDialogOpen && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-full max-w-md">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Name this context</h4>
            <input
              type="text"
              value={saveName}
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                onClick={() => { setIsSaveDialogOpen(false); setSaveName(''); }}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-full max-w-2xl">
            <div className="flex justify-between items-center">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Saved Contexts</h4>
              <button
