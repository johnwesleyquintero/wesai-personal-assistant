        ...
        <div className="flex flex-col h-full bg-app-main rounded-2xl shadow-2xl border border-app-border overflow-hidden transition-all duration-300">
          ...
          <div className="p-6 border-t border-app-border bg-app-secondary/30">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-4 bg-app-accent hover:opacity-90 text-white font-bold text-lg rounded-xl shadow-xl shadow-app-accent/20 transition-all active:scale-[0.98] disabled:opacity-40 disabled:grayscale disabled:cursor-not-allowed"
            >
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {!profile.isActive && (
                      <button
                        ...
                        className="w-full py-2.5 px-4 text-xs font-black text-app-accent bg-app-accent-soft border border-app-accent/20 rounded-xl hover:bg-app-accent hover:text-white transition-all uppercase tracking-widest active:scale-[0.98]"
                      >
                        Activate Agent
                      </button>
                    )}
