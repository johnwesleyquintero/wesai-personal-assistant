  ...
  return (
    <div className="relative group">
      <button
        ...
        className={`absolute top-0 right-0 p-2.5 rounded-xl transition-all duration-200 ease-in-out z-10 opacity-0 group-hover:opacity-100 shadow-sm border active:scale-95
                    ${
                      isCopied
      ...
      <div
        className="prose prose-sm sm:prose-base max-w-none text-app-text dark:text-gray-100 dark:prose-invert
                      prose-headings:text-app-text dark:prose-headings:text-white
                      prose-p:text-app-text dark:prose-p:text-gray-100
                      prose-li:text-app-text dark:prose-li:text-gray-100
                      prose-strong:text-app-text dark:prose-strong:text-white font-bold
